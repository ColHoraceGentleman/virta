...
| 2026-07-09 12:05 MDT | Round 23: manual-entry modal adds a **Name** field to match the GL column. D62 / D64 updated. "Change" is not a field — it's part of the type-aware Amount label for Asset / Liability / Equity. **Notes** is internal-only, not in the GL. Smoke 239/239. | (pending) |
