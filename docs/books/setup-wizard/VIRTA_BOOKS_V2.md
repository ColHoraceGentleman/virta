...
| 2026-07-09 11:56 MDT | Round 20: clear all manual-entry defaults. Type=Expense (the one allowed default), Date=today (computed at modal open), Change + Description + Other account = blank placeholders. Smoke 238/238. | `be2c05a` |
| 2026-07-09 12:00 MDT | Round 21: manual-entry modal picker renamed "Other account" → "Matched with" for consistency with the GL table column (D59). Smoke 238/238. | `1906b4c` |
| 2026-07-09 12:03 MDT | Round 22: manual-entry modal picker renamed "Account" → "Category" for consistency with the GL table column (D59). Modal Account row restructured so the static label is in the template (not populated by setTimeout). Smoke 238/238. | (pending) |
| 2026-07-09 12:05 MDT | Round 23: manual-entry modal adds a **Name** field to match the GL column. D62 / D64 updated. "Change" is not a field — it's part of the type-aware Amount label for Asset / Liability / Equity. **Notes** is internal-only, not in the GL. Smoke 239/239. | `06ed31e` |
| 2026-07-09 12:06 MDT | Round 24: manual-entry modal Amount label is now always **"Amount"**. Type-specific copy ("Change in the Asset" etc.) moved entirely to the helper text. Simpler, fewer words to remember. D64 revised. Smoke 239/239. | (pending) |
