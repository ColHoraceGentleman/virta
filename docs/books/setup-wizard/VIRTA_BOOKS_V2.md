...
| 2026-07-09 12:00 MDT | Round 21: manual-entry modal picker renamed "Other account" → "Matched with" for consistency with the GL table column (D59). Smoke 238/238. | (pending) |
